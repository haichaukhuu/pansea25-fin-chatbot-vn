...
export const ProfilePage: React.FC<ProfilePageProps> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen" style={{ background: `linear-gradient(135deg, #B4B4B2 0%, #FFFFFF 100%)` }}>
      {/* Header */}
      <div className="border-b shadow-sm" style={{ backgroundColor: '#FFFFFF', borderColor: '#21A691' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl font-bold" style={{ color: '#27403E' }}>Profile & Settings</h1>
            </div>
          </div>
        </div>
      </div>
            ...
            <nav className="space-y-1">
              <button
                ...
                style={{
                  ...
                  color: activeTab === 'profile' ? '#FFFFFF' : '#27403E',
                  border: activeTab === 'profile' ? '1px solid #87DF2C' : '1px solid transparent'
                }}
                onMouseEnter={(e) => {
                  if (activeTab !== 'profile') {
                    e.currentTarget.style.backgroundColor = '#B4B4B2';
                  }
                }}
                onMouseLeave={(e) => {
                  if (activeTab !== 'profile') {
              ...
              <button
                ...
                style={{
                  ...
                  color: activeTab === 'account' ? '#FFFFFF' : '#27403E',
                  border: activeTab === 'account' ? '1px solid #87DF2C' : '1px solid transparent'
                }}
                onMouseEnter={(e) => {
              ...
              <button
                ...
                style={{
                  ...
                  color: activeTab === 'preferences' ? '#FFFFFF' : '#27403E',
                  border: activeTab === 'preferences' ? '1px solid #87DF2C' : '1px solid transparent'
                }}
                onMouseEnter={(e) => {
