...
export const PreferencesPage: React.FC<PreferencesPageProps> = ({ onComplete, onBack }) => {
  const { t } = useLanguage();
        ...
        <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-lg p-8 shadow-xl">
          ...
          <div className="mt-8 flex justify-end">
            <button
              ...
              className="px-6 py-3 font-medium rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              style={{
                backgroundColor: isStepValid() ? '#21A691' : '#9CA3AF',
                color: '#ffffff'
              }}
              onMouseEnter={(e) => {
                if (isStepValid()) {
